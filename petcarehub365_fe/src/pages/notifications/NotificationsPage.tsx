          ...
          <div style={{ display:'flex', flexDirection:'column' }}>
            {notifications.map(n => (
              <div key={n._id} style={{
                ...
                <div style={{ width:44, height:44, borderRadius:12, background: n.isRead?'var(--surface2)':'#FFE0E0', display:'flex', alignItems:'center', justifyContent:'center', fontSize:22, flexShrink:0 }}>
                  {ICONS[n.type] || '🔔'}
                </div>
                <div style={{ flex:1 }}>
